...
export const main_interface: Example.Interface = {
  nodes: ["webrtc", "srtInput", "rtmpInput", "compose", "mixer"],
  inputs: [
    Example.ffmpegCommand(Example.srtOutput({ port: 5001 })),
    Example.ffmpegCommand(Example.rtmpOutput({ port: 5002, app: "acme", str: "high" }))
  ],
  outputs: {
    audio: ["webrtc"],
    video: ["webrtc"],
  },
  description: "Compose multiple sources into a single output"
};
