...
export const main_interface: Example.Interface = {
  nodes: ["webrtc", "srtInput", "rtmpInput", "compose"],
  inputs: [
    Example.ffmpegCommand(Example.srtOutput({ port: 5001 })),
    Example.ffmpegCommand({transport: Example.rtmpOutput({ port: 5002, app: "acme", str: "high" }), sources: { src: "rgbtestsrc" }}),
  ],
  outputs: {
    audio: ["webrtc"],
    video: ["webrtc"],
  },
  description: "Picture in picture example, with SRT and RTMP inputs"
};
