import { Norsk, selectAllVideos, selectAudio, selectVideo, StreamMetadata, VideoEncodeLadderRung, videoStreamKeys } from "@id3as/norsk-sdk";
...
export const main_interface: Example.Interface = {
  nodes: ["localRtcOutput", "rtmp", "master", "audio", "high", "low", "medium"],
