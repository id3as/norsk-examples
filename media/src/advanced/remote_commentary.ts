...
export const main_interface: Example.Interface = {
  nodes: ["srtInput", "preview_ladder", "previewRtc", "mixer", "final_ladder", "master", "audio", "high", "low", "medium"],
  inputs: [Example.ffmpegCommand(Example.srtOutput({ port: 5001 }))],
  outputs: {
    playlists: ["256-low", "256-medium", "256-high", "1-default"],
    audio: ["previewRtc", "master"],
    video: ["previewRtc", "master"],
  },
};
